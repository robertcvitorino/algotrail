...
class TrailPolicy
{
    ...
    {
        return $user->can('view_any_trail');
    }
     ...
     */
    public function replicate(User $user, Trail $trail): bool
    {
